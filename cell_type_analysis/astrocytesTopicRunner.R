...
output_dir <- file.path(get_result_dir(), "astrocytes_topics")
...
output_name_prefix <- "all_astrocytes"
print(output_name_prefix)

input_path <- file.path(SEURAT_OBJECT_DATA_PATH, "astrocytes.h5Seurat")
...
# subset fit
output_name_prefix <- "subset_astrocytes"
print(output_name_prefix)

input_path <- file.path(SEURAT_SUBSET_OBJECT_PATH, "astrocytes.subset.rds")
message("Loading data from ", input_path)
